...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			function goReg() {
				location.href="<%=request.getContextPath()%>/applicant/cJobExpRegPage.do";
			}
		</script>
		<style type="text/css">
			.layout {
	...
	<body class="no-sidebar is-preload">
		<div id="page-wrapper">
							...
							<section class="layout">
								...
								<c:forEach var="vo" items="${clist}">
									<tr>
										...
										<td>${fn:substring(vo.startTime,0,5)} ~ ${fn:substring(vo.endTime,0,5)}</td>
										<td>${vo.locate}</td>
									</tr>
								</c:forEach>
								</table>
			...
			%>
											<li class="page-item">
								    			<a href="${path}/applicant/getCList.do?pageNum=<%=startPage - pageBlock%>" class="page-link">‹</a>
								    		</li>
			<%
										}
										...
										for(int i = startPage; i <= endPage; i++) {
											if(i == currentPage) {
			%>											
								    			<li class="page-item active"><a href="${path}/applicant/getCList.do?pageNum=<%=currentPage%>" class="page-link"><%=currentPage %></a></li>
			<%
											} else {
			%>	
								    			<li class="page-item "><a href="${path}/applicant/getCList.do?pageNum=<%=i%>" class="page-link"><%=i %></a></li>
			<%	
											}
