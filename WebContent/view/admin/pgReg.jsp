								...
								<form action="${path}/hireInfo/reg.do" method="post">
									<table border="none">
										...
										<tr>
											<th>프로그램 시간</th>
											<td>
												<input type="time" name="startTime" id="startTime" step="60" min="00:00" max="23:59" required>
												&nbsp;&nbsp;~&nbsp;&nbsp;
												<input type="time" name="endTime" id="startTime" step="60" min="00:00" max="23:59" required>
											</td>
										</tr>
										<tr>
											<th>진행 장소</th>
