							   ...
							   <nav aria-label="Page navigation example">
								     <ul class="pagination justify-content-center">
								        ...
								        <c:if test="${currentPage > 1}">
								            ...
								            <li class="page-item">
								                <a class="page-link" href="${path}/Articles/NewsLetters.do?pageNum=${prevPage}">이전</a>
								            </li>
								        </c:if>
								        ...
								        <c:forEach var="i" begin="1" end="${totalPages}">
								            <c:choose>
								                ...
								                <c:otherwise>
								                    <li class="page-item">
								                        <a class="page-link" href="${path}/Articles/NewsLetters.do?pageNum=${i}">${i}</a>
								                    </li>
								                </c:otherwise>
								            </c:choose>
								        </c:forEach>
								        ...
								        <c:if test="${currentPage < totalPages}">
								            ...
								            <li class="page-item">
								                <a class="page-link" href="${path}/Articles/NewsLetters.do?pageNum=${nextPage}">다음</a>
								            </li>
								        </c:if>
								    </ul>
								</nav>
